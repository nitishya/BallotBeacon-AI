...
const translations = {
  en: {
    ...
    "home.hero.subtitle": "Check eligibility, track deadlines, and get AI-powered answers instantly based on ECI guidelines.",
  ...
  hi: {
    ...
    "home.hero.subtitle": "ECI दिशानिर्देशों के आधार पर पात्रता जांचें, समय सीमा ट्रैक करें और तुरंत AI-संचालित उत्तर प्राप्त करें।",
